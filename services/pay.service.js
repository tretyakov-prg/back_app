...
const {SendMailNodemail} = require("../middlewares/sendMail");
...
exports.getPay = async(req, res) => {
    try {
        ...
        .then(result => {
            ...
            SendMailNodemail(CreateHTMLOrderlight({
                    order: dataOrderParams.order,
                    item:result,
                    name:  dataOrderParams.name,
                ...
                }), dataOrderParams.email, "Product purchase receipt");
